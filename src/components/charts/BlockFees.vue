...
const chartProps = {
  ...
  description: `
    <p>
      ...
      A higher fee will increase the change of transaction being included in the next block.
    </p>
    <p>
      As a general rule, fees go up as the number of transactions increase.
    </p>
    <p>
