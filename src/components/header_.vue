...
const lookBackBlocks = ref(store.getters['chainData/getBlockSpan'])
              ...
              <n-space vertical>
                ...
                <n-form>
                  <n-form-item label="Dark / light mode">
                    <n-button tertiary type="info" size="large" @click="store.dispatch('theme/changeTheme')" :style="{ width: '4em' }">
                      <template #icon>
                        <n-icon :color="themeVars.primaryColor">
                  ...
                  <n-form-item>
                    ...
                    <n-tooltip trigger="hover" placement="bottom">
                      <template #trigger>
                        <n-button @click="store.dispatch('chainData/setBlockSpan', lookBackBlocks)" tertiary>
                          <template #icon>
